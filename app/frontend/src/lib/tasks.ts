...
export const TASKS: Task[] = [
  ...
  { id: 'caPolicies', group: 'insight', page: 'security', keywords: 'conditional access policy условный доступ политики' },
  { id: 'appConsents', group: 'insight', page: 'security', keywords: 'consent oauth enterprise apps согласия разрешения приложений' },
